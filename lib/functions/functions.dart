...
import 'package:tagxibiddingdriver/pages/NavigatorPages/editprofile.dart';
import 'package:tagxibiddingdriver/pages/NavigatorPages/history.dart';
import 'package:tagxibiddingdriver/pages/NavigatorPages/makecomplaint.dart';
import 'package:tagxibiddingdriver/pages/login/get_started.dart';
import 'package:tagxibiddingdriver/pages/login/login.dart';
import 'package:tagxibiddingdriver/pages/onTripPage/digitalsignature.dart';
import 'package:tagxibiddingdriver/pages/onTripPage/droplocation.dart';
import 'package:tagxibiddingdriver/pages/onTripPage/invoice.dart';
import 'package:tagxibiddingdriver/pages/onTripPage/map_page.dart';
import 'package:tagxibiddingdriver/pages/onTripPage/review_page.dart';
...
import 'package:tagxibiddingdriver/pages/vehicleInformations/service_area.dart';
import 'package:tagxibiddingdriver/pages/vehicleInformations/upload_docs.dart';
...
import 'package:tagxibiddingdriver/pages/vehicleInformations/vehicle_model.dart';
import 'package:tagxibiddingdriver/pages/vehicleInformations/vehicle_number.dart';
import 'package:tagxibiddingdriver/pages/vehicleInformations/vehicle_type.dart';
import 'package:http/http.dart' as http;
import 'package:firebase_auth/firebase_auth.dart';
import 'package:firebase_database/firebase_database.dart';
import 'package:firebase_messaging/firebase_messaging.dart';
import 'package:tagxibiddingdriver/pages/vehicleInformations/vehicle_year.dart';
    ...
    if (event.snapshot.value != null) {
      ...
      list.forEach((key, value) {
        if (value['drivers'] != null &&
          ...
          if (value['drivers']['${userDetails["id"]}'] != null) {
            if (value['drivers']['${userDetails["id"]}']["is_rejected"] ==
                'none') {
              rideList.add(value);

              waitingList.add(value);
            } else if (value['drivers']['${userDetails["id"]}']
                    ["is_rejected"] !=
                'by_driver') {
              rideList.add(value);
            }
