...
import 'package:tagxibiddingdriver/functions/geohash.dart';
...
import 'package:tagxibiddingdriver/pages/chatPage/chat_page.dart';
                                                                  ...
                                                                  Container(
                                                                    ...
                                                                    child: StatefulBuilder(builder:
                                                                      ...
                                                                      return InkWell(
                                                                          ...
                                                                          child: Icon((userDetails['role'] == 'owner')
                                                                              ? Icons.menu
                                                                              : Icons.arrow_back));
                                                                    }),
                                                                  ),
                                                                                            ...
                                                                                            children: [
                                                                                              InkWell(
                                                                                                ...
                                                                                                child: Container(
                                                                                                  ...
                                                                                                  child: Text(
                                                                                                    '-10',
                                                                                                    style: GoogleFonts.roboto(fontSize: media.width * fourteen, fontWeight: FontWeight.w600, color: page),
                                                                                                  ),
                                                                                                ),
                                                                                              ),
                                                                                              SizedBox(
                                                                                                ...
                                                                                                child: TextField(
                                                                                                  ...
                                                                                                  decoration: InputDecoration(
                                                                                                    ...
                                                                                                    hintStyle: GoogleFonts.roboto(fontSize: media.width * sixteen, color: textColor),
                                                                                            ...
                                                                                            child: Button(
                                                                                                onTap: () async {
                                                                                                  if (bidText.text.isNotEmpty || choosenRide[0]['price'] != null) {
                                                                                                    ...
                                                                                                    try {
                                                                                                      await FirebaseDatabase.instance.ref().child('bid-meta/${choosenRide[0]["request_id"]}/drivers/${userDetails["id"]}').update({
                                                                                                ...
                                                                                                text:
                                                                                                    // 'bidddddd',
                                                                                                    languages[choosenLanguage]['text_bid']))
                                                                                      ],
                                                                                    ),
                                                                                  )
                                                                                ],
